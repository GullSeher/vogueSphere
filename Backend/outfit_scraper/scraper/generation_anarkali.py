...
CACHE_FILE_NAME = "Generation Anarkali.json"
...
# ---------------- SCRAPER ----------------
def scrape_generation_anarkali():
    ...
    url = "https://generation.com.pk/collections/anarkali-frock?srsltid=AfmBOor8fFq83MuIWp9hvec22Mx8Hq_JozMW7peRHuj_IUwMhA9p1zRO"
    print("📡 Opening:", url)
    driver.get(url)
    time.sleep(5)
...
# --------------------------
def get_generation_anarkali_products():
    """Wrapper function for scraper handler."""
    return scrape_generation_anarkali()


# Optional test
if __name__ == "__main__":
    products = get_generation_anarkali_products()
    print(f"📝 Total Generation Anarkali products scraped: {len(products)}")
